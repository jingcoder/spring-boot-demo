...
public class CustomerCacheEventListener implements CacheEventListener {
    ...
    public void notifyElementRemoved(Ehcache ehcache, Element element) throws CacheException {
        logger.info("cache removed. key = {}, value = {}, ehcache-name = {}", element.getObjectKey(), element.getObjectValue(),ehcache.getName());
    }

    @Override
    public void notifyElementPut(Ehcache ehcache, Element element) throws CacheException {
        logger.info("cache put. key = {}, value = {}, ehcache-name = {}", element.getObjectKey(), element.getObjectValue(),ehcache.getName());
    }
